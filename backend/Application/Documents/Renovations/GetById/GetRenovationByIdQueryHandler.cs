...
public class GetRenovationByIdQueryHandler : IRequestHandler<GetRenovationByIdQuery, ErrorOr<RenovationResponseDTO>>
{
    private readonly IRenovationRepository _renovationRepository;
    public GetRenovationByIdQueryHandler(IRenovationRepository renovationRepository)
    {
