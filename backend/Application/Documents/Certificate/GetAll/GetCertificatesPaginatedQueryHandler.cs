...
public sealed class GetCertificatesPaginatedQueryHandler(ICertificateRepository certificateRepository) : IRequestHandler<GetCertificatesPaginatedQuery, ErrorOr<PaginatedResult<CertificateResponseDTO>>>,
